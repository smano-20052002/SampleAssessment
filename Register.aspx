<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="SampleAssessment.Register" %>
  ...
  <div class='window'>
    ...
    <form class='content' runat="server" >
      ...
      <div class='input-fields'>
          <asp:TextBox ID="TextBox3" class="input input-line full-width" runat="server" TextMode="SingleLine"></asp:TextBox>
      ...
      <a href="Login.aspx" class='spacing'>Already have an<span class='highlight'>Account</span></a>
      <div>
