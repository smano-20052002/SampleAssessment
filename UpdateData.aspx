<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateData.aspx.cs" Inherits="SampleAssessment.UpdateData" %>
       ...
       <div class="card">
           ...
           <div class="card-body">
               ...
               <form id="bookingForm" action="#" method="" class="needs-validation" novalidate autocomplete="off">
                   ...
                   <asp:Button ID="Button1" runat="server" Text="Update" class="btn btn-primary btn-block col-lg-2" OnClick="Button1_Click" />
